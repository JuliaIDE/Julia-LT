...
lt.objs.langs.julia.connect = (function connect(){lt.objs.notifos.working.call(null,"Connecting to Julia...");
...
var pred__8726 = cljs.core._EQ_;var expr__8727 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8726.call(null,"result",expr__8727)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__8726.call(null,"error",expr__8727)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__8726.call(null,"hints",expr__8727)))
...
lt.object.merge_BANG_.call(null,editor,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.julia","hints","lt.objs.langs.julia/hints",1553189147),cljs.core.map.call(null,(function (p1__8722_SHARP_){return {"completion": p1__8722_SHARP_};
...
{if(cljs.core.truth_(pred__8726.call(null,"doc",expr__8727)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8727)].join('')));
}
}
}
}
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__8732 = cljs.core._EQ_;var expr__8733 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8732.call(null,"popup",expr__8733)))
...
{if(cljs.core.truth_(pred__8732.call(null,"print",expr__8733)))
...
{if(cljs.core.truth_(pred__8732.call(null,"done",expr__8733)))
...
{if(cljs.core.truth_(pred__8732.call(null,"notify",expr__8733)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8733)].join('')));
}
}
}
}
