...
lt.objs.langs.julia.__BEH__editor_commands = (function __BEH__editor_commands(editor,res){var pred__7232 = cljs.core._EQ_;var expr__7233 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__7232.call(null,"result",expr__7233)))
...
{if(cljs.core.truth_(pred__7232.call(null,"error",expr__7233)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__7233)].join('')));
}
}
});
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__7238 = cljs.core._EQ_;var expr__7239 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__7238.call(null,"popup",expr__7239)))
...
{if(cljs.core.truth_(pred__7238.call(null,"print",expr__7239)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__7239)].join('')));
}
}
});
...
cljs.core.prn.call(null,lt.objs.langs.julia.julia);

lt.objs.langs.julia.__BEH__eval__DOT__one = (function __BEH__eval__DOT__one(editor){return lt.objs.clients.send.call(null,lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.eval.julia","editor.eval.julia",3010658330),new cljs.core.Keyword(null,"origin","origin",4300251800),editor,new cljs.core.Keyword(null,"info","info",1017141280),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"create","create",3956577390),lt.objs.langs.julia.connect_manual], null)),new cljs.core.Keyword(null,"editor.eval.julia","editor.eval.julia",3010658330),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"code","code",1016963423),lt.objs.langs.julia.current_buffer_content.call(null),new cljs.core.Keyword(null,"start","start",1123661780),lt.objs.langs.julia.cursor.call(null,editor,"start"),new cljs.core.Keyword(null,"end","end",1014004813),lt.objs.langs.julia.cursor.call(null,editor,"end")], null),new cljs.core.Keyword(null,"only","only",1017320222),editor);
});
