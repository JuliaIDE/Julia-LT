...
lt.objs.langs.julia.julia_path = (function julia_path(){var or__6813__auto__ = cljs.core.deref.call(null,lt.objs.langs.julia.julia).call(null,new cljs.core.Keyword(null,"path","path",1017337751));if(cljs.core.truth_(or__6813__auto__))
{return or__6813__auto__;
} else
{return "julia";
}
});
lt.objs.langs.julia.connect = (function connect(notify){if(cljs.core.truth_(notify))
{lt.objs.notifos.working.call(null,"Spinning up a Julia client...");
} else
{}
var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"julia.client","julia.client",3830708594));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.objs.langs.julia","connecting-notifier","lt.objs.langs.julia/connecting-notifier",1318705770),client);lt.object.merge_BANG_.call(null,obj,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"notify","notify",4269181627),notify], null));
...
lt.objs.langs.julia.connect_notify = (function connect_notify(){return lt.objs.langs.julia.connect.call(null,true);
});
...
var pred__8486 = cljs.core._EQ_;var expr__8487 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8486.call(null,"result",expr__8487)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__8486.call(null,"error",expr__8487)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__8486.call(null,"hints",expr__8487)))
...
lt.object.merge_BANG_.call(null,editor,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.julia","hints","lt.objs.langs.julia/hints",1553189147),cljs.core.map.call(null,(function (p1__8482_SHARP_){return {"completion": p1__8482_SHARP_};
...
{if(cljs.core.truth_(pred__8486.call(null,"doc",expr__8487)))
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__8492 = cljs.core._EQ_;var expr__8493 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8492.call(null,"popup",expr__8493)))
...
{if(cljs.core.truth_(pred__8492.call(null,"print",expr__8493)))
...
{if(cljs.core.truth_(pred__8492.call(null,"done",expr__8493)))
...
{if(cljs.core.truth_(pred__8492.call(null,"notify",expr__8493)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8493)].join('')));
}
}
}
}
...
}),(function (){return lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.julia.eval","editor.julia.eval",4568286884),new cljs.core.Keyword(null,"info","info",1017141280),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"origin","origin",4300251800),lt.objs.langs.julia.julia,new cljs.core.Keyword(null,"create","create",3956577390),lt.objs.langs.julia.connect_notify], null));
}));
});
...
lt.objs.langs.julia.__BEH__connect_on_open = (function __BEH__connect_on_open(editor){return lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.eval.julia","editor.eval.julia",3010658330),new cljs.core.Keyword(null,"origin","origin",4300251800),editor,new cljs.core.Keyword(null,"info","info",1017141280),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"create","create",3956577390),lt.objs.langs.julia.connect_notify], null));
});
