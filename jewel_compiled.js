...
var connect__delegate = function (p__7879){var map__7881 = p__7879;var map__7881__$1 = ((cljs.core.seq_QMARK_.call(null,map__7881))?cljs.core.apply.call(null,cljs.core.hash_map,map__7881):map__7881);var complain = cljs.core.get.call(null,map__7881__$1,new cljs.core.Keyword(null,"complain","complain",4709422171),true);var notify = cljs.core.get.call(null,map__7881__$1,new cljs.core.Keyword(null,"notify","notify",4269181627),false);if(cljs.core.truth_(notify))
...
var p__7879 = null;if (arguments.length > 0) {
  p__7879 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return connect__delegate.call(this,p__7879);};
connect.cljs$lang$maxFixedArity = 0;
connect.cljs$lang$applyTo = (function (arglist__7903){
var p__7879 = cljs.core.seq(arglist__7903);
return connect__delegate(p__7879);
});
...
var pred__7886 = cljs.core._EQ_;var expr__7887 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__7886.call(null,"result",expr__7887)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__7886.call(null,"error",expr__7887)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__7886.call(null,"hints",expr__7887)))
...
lt.object.merge_BANG_.call(null,editor,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.julia","hints","lt.objs.langs.julia/hints",1553189147),cljs.core.map.call(null,((function (pred__7886,expr__7887){
return (function (p1__7882_SHARP_){return {"completion": p1__7882_SHARP_};
});})(pred__7886,expr__7887))
...
{if(cljs.core.truth_(pred__7886.call(null,"doc",expr__7887)))
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__7892 = cljs.core._EQ_;var expr__7893 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__7892.call(null,"popup",expr__7893)))
...
{if(cljs.core.truth_(pred__7892.call(null,"print",expr__7893)))
...
{if(cljs.core.truth_(pred__7892.call(null,"done",expr__7893)))
...
{if(cljs.core.truth_(pred__7892.call(null,"notify",expr__7893)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__7893)].join('')));
}
}
}
}
...
lt.objs.proc.simple_spawn_STAR_ = (function (obj,p__7899,cwd_QMARK_,env){var map__7900 = p__7899;var map__7900__$1 = ((cljs.core.seq_QMARK_.call(null,map__7900))?cljs.core.apply.call(null,cljs.core.hash_map,map__7900):map__7900);var args = cljs.core.get.call(null,map__7900__$1,new cljs.core.Keyword(null,"args","args",1016906831));var command = cljs.core.get.call(null,map__7900__$1,new cljs.core.Keyword(null,"command","command",1964298941));var proc = lt.objs.proc.spawn.call(null,command,((cljs.core.seq.call(null,args))?cljs.core.clj__GT_js.call(null,args):null),(function (){var obj7902 = {"cwd":cwd_QMARK_,"env":lt.objs.proc.merge_env.call(null,env)};return obj7902;
})());lt.objs.proc.add_BANG_.call(null,proc);
proc.on("exit",cljs.core.partial.call(null,lt.objs.proc.rem_BANG_,proc));
proc.on("error",((function (proc,map__7900,map__7900__$1,args,command){
return (function (p1__7895_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,obj)))
{cljs.core.println.call(null,[cljs.core.str(p1__7895_SHARP_)].join(''),([cljs.core.str(p1__7895_SHARP_)].join('').indexOf("ENOENT") > -1));
if(([cljs.core.str(p1__7895_SHARP_)].join('').indexOf("ENOENT") > -1))
...
{return lt.object.raise.call(null,obj,new cljs.core.Keyword(null,"proc.error","proc.error",4143512802),p1__7895_SHARP_);
}
} else
{return null;
}
});})(proc,map__7900,map__7900__$1,args,command))
);
proc.stderr.on("data",((function (proc,map__7900,map__7900__$1,args,command){
return (function (p1__7896_SHARP_){if(cljs.core.not.call(null,cljs.core.deref.call(null,obj)))
{return cljs.core.println.call(null,"ERROR running: ",command);
} else
{return lt.object.raise.call(null,obj,new cljs.core.Keyword(null,"proc.error","proc.error",4143512802),p1__7896_SHARP_);
}
});})(proc,map__7900,map__7900__$1,args,command))
);
proc.stdout.on("data",((function (proc,map__7900,map__7900__$1,args,command){
return (function (p1__7897_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,obj)))
{return lt.object.raise.call(null,obj,new cljs.core.Keyword(null,"proc.out","proc.out",4302083112),p1__7897_SHARP_);
} else
{return null;
}
});})(proc,map__7900,map__7900__$1,args,command))
);
return proc.on("exit",((function (proc,map__7900,map__7900__$1,args,command){
return (function (p1__7898_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,obj)))
{return lt.object.raise.call(null,obj,new cljs.core.Keyword(null,"proc.exit","proc.exit",4162906152),p1__7898_SHARP_);
} else
{return null;
}
});})(proc,map__7900,map__7900__$1,args,command))
