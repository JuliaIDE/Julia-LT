...
var connect__delegate = function (p__8273){var map__8275 = p__8273;var map__8275__$1 = ((cljs.core.seq_QMARK_.call(null,map__8275))?cljs.core.apply.call(null,cljs.core.hash_map,map__8275):map__8275);var complain = cljs.core.get.call(null,map__8275__$1,new cljs.core.Keyword(null,"complain","complain",4709422171),true);var notify = cljs.core.get.call(null,map__8275__$1,new cljs.core.Keyword(null,"notify","notify",4269181627),false);if(cljs.core.truth_(notify))
...
var p__8273 = null;if (arguments.length > 0) {
  p__8273 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return connect__delegate.call(this,p__8273);};
connect.cljs$lang$maxFixedArity = 0;
connect.cljs$lang$applyTo = (function (arglist__8307){
var p__8273 = cljs.core.seq(arglist__8307);
return connect__delegate(p__8273);
});
...
var pred__8280 = cljs.core._EQ_;var expr__8281 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8280.call(null,"result",expr__8281)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__8280.call(null,"error",expr__8281)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__8280.call(null,"hints",expr__8281)))
...
lt.object.merge_BANG_.call(null,editor,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.julia","hints","lt.objs.langs.julia/hints",1553189147),cljs.core.map.call(null,(function (p1__8276_SHARP_){return {"completion": p1__8276_SHARP_};
...
{if(cljs.core.truth_(pred__8280.call(null,"doc",expr__8281)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8281)].join('')));
}
}
}
}
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__8286 = cljs.core._EQ_;var expr__8287 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8286.call(null,"popup",expr__8287)))
...
{if(cljs.core.truth_(pred__8286.call(null,"print",expr__8287)))
...
{if(cljs.core.truth_(pred__8286.call(null,"done",expr__8287)))
...
{if(cljs.core.truth_(pred__8286.call(null,"notify",expr__8287)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8287)].join('')));
}
}
}
}
...
lt.objs.proc.simple_spawn_STAR_ = (function (obj,p__8293,cwd_QMARK_,env){var map__8294 = p__8293;var map__8294__$1 = ((cljs.core.seq_QMARK_.call(null,map__8294))?cljs.core.apply.call(null,cljs.core.hash_map,map__8294):map__8294);var args = cljs.core.get.call(null,map__8294__$1,new cljs.core.Keyword(null,"args","args",1016906831));var command = cljs.core.get.call(null,map__8294__$1,new cljs.core.Keyword(null,"command","command",1964298941));var proc = lt.objs.proc.spawn.call(null,command,((cljs.core.seq.call(null,args))?cljs.core.clj__GT_js.call(null,args):null),(function (){var obj8296 = {"cwd":cwd_QMARK_,"env":lt.objs.proc.merge_env.call(null,env)};return obj8296;
})());lt.objs.proc.add_BANG_.call(null,proc);
proc.on("exit",cljs.core.partial.call(null,lt.objs.proc.rem_BANG_,proc));
proc.on("error",(function (p1__8289_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,obj)))
{cljs.core.println.call(null,[cljs.core.str(p1__8289_SHARP_)].join(''),([cljs.core.str(p1__8289_SHARP_)].join('').indexOf("ENOENT") > -1));
if(([cljs.core.str(p1__8289_SHARP_)].join('').indexOf("ENOENT") > -1))
...
{return lt.object.raise.call(null,obj,new cljs.core.Keyword(null,"proc.error","proc.error",4143512802),p1__8289_SHARP_);
}
} else
{return null;
}
}));
proc.stderr.on("data",(function (p1__8290_SHARP_){if(cljs.core.not.call(null,cljs.core.deref.call(null,obj)))
{return cljs.core.println.call(null,"ERROR running: ",command);
} else
{return lt.object.raise.call(null,obj,new cljs.core.Keyword(null,"proc.error","proc.error",4143512802),p1__8290_SHARP_);
}
}));
proc.stdout.on("data",(function (p1__8291_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,obj)))
{return lt.object.raise.call(null,obj,new cljs.core.Keyword(null,"proc.out","proc.out",4302083112),p1__8291_SHARP_);
} else
{return null;
}
}));
return proc.on("exit",(function (p1__8292_SHARP_){if(cljs.core.truth_(cljs.core.deref.call(null,obj)))
{return lt.object.raise.call(null,obj,new cljs.core.Keyword(null,"proc.exit","proc.exit",4162906152),p1__8292_SHARP_);
} else
{return null;
}
}),proc);
