...
var pred__8326 = cljs.core._EQ_;var expr__8327 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8326.call(null,"result",expr__8327)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__8326.call(null,"error",expr__8327)))
{lt.objs.notifos.done_working.call(null,"");
...
{if(cljs.core.truth_(pred__8326.call(null,"hints",expr__8327)))
...
lt.object.merge_BANG_.call(null,editor,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.julia","hints","lt.objs.langs.julia/hints",1553189147),cljs.core.map.call(null,(function (p1__8322_SHARP_){return {"completion": p1__8322_SHARP_};
...
{if(cljs.core.truth_(pred__8326.call(null,"doc",expr__8327)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8327)].join('')));
}
}
}
}
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__8332 = cljs.core._EQ_;var expr__8333 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8332.call(null,"popup",expr__8333)))
...
{if(cljs.core.truth_(pred__8332.call(null,"print",expr__8333)))
...
{if(cljs.core.truth_(pred__8332.call(null,"done",expr__8333)))
...
{if(cljs.core.truth_(pred__8332.call(null,"notify",expr__8333)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8333)].join('')));
}
}
}
}
