...
var pred__7434 = cljs.core._EQ_;var expr__7435 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__7434.call(null,"result",expr__7435)))
...
{if(cljs.core.truth_(pred__7434.call(null,"error",expr__7435)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__7435)].join('')));
}
}
});
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__7440 = cljs.core._EQ_;var expr__7441 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__7440.call(null,"popup",expr__7441)))
...
{if(cljs.core.truth_(pred__7440.call(null,"print",expr__7441)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__7441)].join('')));
}
}
});
