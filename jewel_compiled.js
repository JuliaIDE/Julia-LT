...
{return lt.objs.console.log.call(null,out);
}
});
...
lt.objs.langs.julia.__BEH__proc_error = (function __BEH__proc_error(this$,data){var out = data.toString();lt.objs.console.log.call(null,out,"error");
...
var pred__7440 = cljs.core._EQ_;var expr__7441 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__7440.call(null,"result",expr__7441)))
...
{if(cljs.core.truth_(pred__7440.call(null,"error",expr__7441)))
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__7446 = cljs.core._EQ_;var expr__7447 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__7446.call(null,"popup",expr__7447)))
...
{if(cljs.core.truth_(pred__7446.call(null,"print",expr__7447)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__7447)].join('')));
}
}
});
...
lt.objs.langs.julia.__BEH__eval__DOT__one = (function __BEH__eval__DOT__one(editor){lt.objs.notifos.working.call(null,"");
return lt.objs.clients.send.call(null,lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.eval.julia","editor.eval.julia",3010658330),new cljs.core.Keyword(null,"origin","origin",4300251800),editor,new cljs.core.Keyword(null,"info","info",1017141280),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"create","create",3956577390),lt.objs.langs.julia.connect], null)),new cljs.core.Keyword(null,"editor.eval.julia","editor.eval.julia",3010658330),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"code","code",1016963423),lt.objs.langs.julia.current_buffer_content.call(null),new cljs.core.Keyword(null,"start","start",1123661780),lt.objs.langs.julia.cursor.call(null,editor,"start"),new cljs.core.Keyword(null,"end","end",1014004813),lt.objs.langs.julia.cursor.call(null,editor,"end")], null),new cljs.core.Keyword(null,"only","only",1017320222),editor);
});
