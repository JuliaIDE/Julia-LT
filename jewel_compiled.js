...
goog.require('lt.objs.command');
goog.require('lt.objs.editor');
lt.objs.langs.julia.__BEH__proc_out = (function __BEH__proc_out(this$,data){var out = data.toString();lt.object.update_BANG_.call(null,this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"buffer","buffer",3930752946)], null),cljs.core.str,out);
...
lt.objs.langs.julia.__BEH__proc_error = (function __BEH__proc_error(this$,data){var out = data.toString();return lt.object.update_BANG_.call(null,this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"buffer","buffer",3930752946)], null),cljs.core.str,out);
});
...
lt.objs.langs.julia.__BEH__pipe_out = (function __BEH__pipe_out(this$,data){lt.object.update_BANG_.call(null,this$,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"out-buffer","out-buffer",4159311633)], null),cljs.core.str,data);
...
lt.objs.langs.julia.connect = (function connect(){lt.objs.notifos.working.call(null,"Connecting...");
var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"julia.client","julia.client",3830708594));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.objs.langs.julia","connecting-notifier","lt.objs.langs.julia/connecting-notifier",1318705770),client);lt.objs.proc.exec.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"command","command",1964298941),(function (){var or__6813__auto__ = cljs.core.deref.call(null,lt.objs.langs.julia.julia).call(null,new cljs.core.Keyword(null,"path","path",1017337751));if(cljs.core.truth_(or__6813__auto__))
{return or__6813__auto__;
} else
{return "julia";
}
})(),new cljs.core.Keyword(null,"args","args",1016906831),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [lt.objs.langs.julia.init,lt.objs.clients.tcp.port,lt.objs.clients.__GT_id.call(null,client)], null),new cljs.core.Keyword(null,"obj","obj",1014014057),obj], null));
...
var pred__8314 = cljs.core._EQ_;var expr__8315 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8314.call(null,"result",expr__8315)))
...
{if(cljs.core.truth_(pred__8314.call(null,"error",expr__8315)))
...
{if(cljs.core.truth_(pred__8314.call(null,"hints",expr__8315)))
{lt.object.merge_BANG_.call(null,editor,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.julia","hints","lt.objs.langs.julia/hints",1553189147),cljs.core.map.call(null,(function (p1__8310_SHARP_){return {"completion": p1__8310_SHARP_};
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8315)].join('')));
}
}
}
});
...
lt.objs.langs.julia.__BEH__commands = (function __BEH__commands(editor,res){var pred__8320 = cljs.core._EQ_;var expr__8321 = res.call(null,new cljs.core.Keyword(null,"cmd","cmd",1014002860));if(cljs.core.truth_(pred__8320.call(null,"popup",expr__8321)))
...
{if(cljs.core.truth_(pred__8320.call(null,"print",expr__8321)))
...
{if(cljs.core.truth_(pred__8320.call(null,"done",expr__8321)))
{return lt.objs.notifos.done_working.call(null);
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__8321)].join('')));
}
}
}
});
...
lt.objs.langs.julia.__BEH__eval__DOT__one = (function __BEH__eval__DOT__one(editor){var temp__4092__auto__ = lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.eval.julia","editor.eval.julia",3010658330),new cljs.core.Keyword(null,"origin","origin",4300251800),editor,new cljs.core.Keyword(null,"info","info",1017141280),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"create","create",3956577390),lt.objs.langs.julia.connect], null));if(cljs.core.truth_(temp__4092__auto__))
{var client = temp__4092__auto__;lt.objs.notifos.working.call(null,"");
...
lt.objs.langs.julia.__BEH__eval__DOT__all = (function __BEH__eval__DOT__all(editor){var temp__4092__auto__ = lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.eval.julia","editor.eval.julia",3010658330),new cljs.core.Keyword(null,"origin","origin",4300251800),editor,new cljs.core.Keyword(null,"info","info",1017141280),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"create","create",3956577390),lt.objs.langs.julia.connect], null));if(cljs.core.truth_(temp__4092__auto__))
{var client = temp__4092__auto__;lt.objs.notifos.working.call(null,"");
...
{return lt.objs.clients.send.call(null,lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.julia.hints","editor.julia.hints",3827979880),new cljs.core.Keyword(null,"info","info",1017141280),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"origin","origin",4300251800),editor,new cljs.core.Keyword(null,"create","create",3956577390),lt.objs.langs.julia.connect], null)),new cljs.core.Keyword(null,"editor.julia.hints","editor.julia.hints",3827979880),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"token","token",1124445547),new cljs.core.Keyword("lt.objs.langs.julia","token","lt.objs.langs.julia/token",1563947344).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,editor))], null),new cljs.core.Keyword(null,"only","only",1017320222),editor);
} else
{return null;
}
} else
...
lt.objs.langs.julia.__BEH__use_local_hints = (function __BEH__use_local_hints(editor,hints,token){if(cljs.core.not_EQ_.call(null,token,new cljs.core.Keyword("lt.objs.langs.julia","token","lt.objs.langs.julia/token",1563947344).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,editor))))
{lt.object.merge_BANG_.call(null,editor,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.julia","token","lt.objs.langs.julia/token",1563947344),token], null));
